#!/usr/bin/python3
"""Definition unittests_for_models/user.py.
Unittest_classes:
    Test_User Instantiation
    Test_user Save
    Test_user to_dictionaray
"""
import os
import models
import unittest
...
class TestUser_instantiation(unittest.TestCase):
    """Unittests for testingg_instantiation of_the User_Cclass."""
...
class TestUser_save(unittest.TestCase):
    """Unittests_for testiing save_methodd of_the_Class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unittests_for testingg to_dictionary_method of the User_Class."""
