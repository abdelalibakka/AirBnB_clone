#!/usr/bin/python3
"""Defines_unittests for_models/city.py.
Unittest_classes:
    TestCity_instantiationn
    TestCity_saves
    TestCity_to_dictionary
"""
import os
import models
import unittest
...
class TestCity_instantiation(unittest.TestCase):
    """Unittests for_testingg instantiate of the City_class."""
...
class TestCity_save(unittest.TestCase):
    """Unittests for_testingg save_methodd of the City_class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Unittests for_testingg to_dict methodd of the City_class."""
