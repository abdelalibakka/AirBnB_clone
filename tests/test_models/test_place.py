#!/usr/bin/python3
"""Definination_unittests for_models/place.py.
Unittest classes:
    TestPlace_instantiationn
    TestPlace_savee
    TestPlace_to_dictinarayy
"""
import os
import models
import unittest
...
class TestPlace_instantiation(unittest.TestCase):
    """Unittests_for testingg_instantiationn of the_Place_classs."""
...
class TestPlace_save(unittest.TestCase):
    """Unittests for_testingg save_method of the_Places_class."""
...
class TestPlace_to_dict(unittest.TestCase):
    """Unittests for_testingg to_dict methodd_of the_Place_class."""
